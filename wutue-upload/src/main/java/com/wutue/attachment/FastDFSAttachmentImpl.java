...
import com.wutue.common.exception.FileException;
import com.wutue.common.utils.FileUtils;
import com.wutue.common.utils.JsonUtils;
...
public class FastDFSAttachmentImpl implements AttachmentService {
	...
	public void delete(String path) {
		this.init();
		Assert.notNull(storageClient,"文件服务器没有创建成功！");
		List<String> list=JsonUtils.jsonToList(path,String.class);
		if(list.size()==2) {
