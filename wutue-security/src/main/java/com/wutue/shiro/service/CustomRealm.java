package com.wutue.shiro.service;
...
public class CustomRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(
        ...
        //权限名的集合
        Set<String> wutues = new HashSet<String>();
        ...
        for (ModuleView moduleView : loginUserVM.getModules()) {
        	wutues.add(moduleView.getName());
		}
    
        //查到权限数据，返回授权信息(要包括 上边的wutues)
        SimpleAuthorizationInfo simpleAuthorizationInfo = new SimpleAuthorizationInfo();
        //将上边查询到授权信息填充到simpleAuthorizationInfo对象中      
        simpleAuthorizationInfo.setRoles(roles);
        simpleAuthorizationInfo.setStringPermissions(wutues);
